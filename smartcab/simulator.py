...
class Simulator(object):
    ...
    def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False, func="",
                 alpha_type=""):
        self.env = env
        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized:  # Whether the user is optimizing the parameters and decay functions
                    self.log_filename = os.path.join("logs", "sim_improved-learning" + func + alpha_type + ".csv")
                    self.table_filename = os.path.join("logs", "sim_improved-learning" + func + alpha_type + ".txt")
                else:
                    self.log_filename = os.path.join("logs", "sim_default-learning" + func + alpha_type + ".csv")
                    self.table_filename = os.path.join("logs", "sim_default-learning" + func + alpha_type + ".txt")
